...
import BlockData
import GasData   # with H2O - causes problems
...
def gsread(outFile):
    ...
    linv1 = BlockData.linv1
    #linv2 = [0 for i in range(40)]
    linv2 = BlockData.linv2
