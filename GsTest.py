...
#print("GsTest: pe0 ", pe0, " p0 ", p0, " neq ", neq)
...
#print("GsTest: rho ", rho)
#print("GsTest: gmu ", gmu)
...
#c     call time(1,0,mscpu)
#c      cpu3=mscpu/1000.0
#c      write(6,200) cpu1,cpu2,cpu3
#c  200 format('0cputime after initialization = ',f9.3,' sec'/
#c     #       '         after final solution = ',f9.3,' sec'/
#c     #       '         after calc. of pp array',f9.3,' sec')
